...
| 3.2  | Forward returns are targets only       | **PASS** — `{return_1d ... return_20d}` disjoint from `feature_cols` (assertion in cell 25, under the §9b markdown header at cell 24). T2: 0 overlaps / 772 features.                              |
